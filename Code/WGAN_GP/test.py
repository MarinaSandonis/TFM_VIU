...
test_generator = DataGenerator(df_test, 
                                  ...
                                  shuffle = False) #El shuffle solo nos iteresa en Train
...
generator.summary()
dcgan = DCGAN(discriminator=discriminator, generator=generator, latent_dim=z_dim, critic_steps=1, gp_weight=7)
...
filepath = "Best_DCGAN_Adamaxdiscri_Adamagenera_001lrd_0002lrg_01dropout_100zdim_4layers_8filters_Completo_Balance.h5"
...
for i in range(0, y_pred.shape[0]):
     ...
     print(original.shape, recon.shape)
